...
class DropCheck extends React.Component {
    ...
    getPanels=()=>{
        ...
        const panels = panelNames.map(function(value, index){
            ...
            var active = ( _me.props.dropCheck.activePanel == value) ? "tab_nav_item active"
                                                                     : "tab_nav_item ";
            return(
    ...
    getActivePanel=()=> {
        ...
        switch(this.props.dropCheck.activePanel){
            ...
            case "Rules":
                return <Rules rules = '1 3'/>;

            case "Values":
                return <Values data = {this.props.dropCheck.data.optionValues}
                                dataChange = {this.props.dataChange}/>;
            default:
                return <General data = {this.props.dropCheck.data}
                                dataChange = {this.props.dataChange}/>;
        }
    }
